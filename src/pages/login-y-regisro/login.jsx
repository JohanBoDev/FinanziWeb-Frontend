        ...
        <><Header />
            <div className="h-screen flex bg-conversor ">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 overflow-hidden">
                    {/* Formulario */}
                    <div className="p-36 text-white w-full flex flex-col justify-center">
                        <h2 className="text-3xl font-bold tracking-wide">
                            Bienvenido de nuevo a <span className="text-[#FB2C36] font-bold drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">FINANZI</span>
                        </h2>  <p className="text-gray-300 mt-1 text-center">Accede a tu cuenta</p>
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-between text-sm text-gray-300 mt-1">
                                ...
                                <Link to="/recuperar-contrasena" className="text-[#FB2C36] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] hover:underline transition">
                        ...
                        <p className="text-gray-300 mt-6 text-center text-sm">
                            ¿No tienes cuenta?{" "}
                            <Link to="/registrar" className="text-[#FB2C36] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)] hover:underline transition">
                                Regístrate
                            </Link>
                        </p>
                    </div>
