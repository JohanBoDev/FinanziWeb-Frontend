    ...
    return (
        <div className='w-full h-screen bg-cover bg-center bg-no-repeat bg-presupuesto relative flex flex-row'>
            <div className='pl-20 pt-10 flex flex-col justify-center gap-y-2 text-start w-1/2'>
                <h1 className="text-[#FF4949] text-[80px] tracking-wider uppercase">
                    Presupuesto Mensual
                </h1>
                ...
                <h1 className='text-[#9D9488] text-[80px] tracking-wider uppercase'>
                    Beneficios Clave
                </h1>
...
<div className='relative w-1/2 h-full'>
    <img className='absolute right-0 top-0 h-full' src={img} alt="" />
