...
import img from "@/assets/img/ahorros-prueba.webp";
...
const CalculadoraAhorros = () => {
  ...
  return (
    ...
    <Header />
      ...
      {/* Formulario */}
      <section className="w-full min-h-screen flex items-center justify-center px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 text-white">
        <div className="w-full max-w-3xl">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">
            Calculadora de{" "}
            <span className="text-[#FB2C36] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
              Ahorros
            </span>
          </h2>
            ...
            >
              ...
              <div className="md:col-span-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#FB2C36] hover:bg-[#d9262f] text-white font-semibold py-2.5 rounded-md transition duration-300 ease-in-out shadow hover:cursor-pointer"
                >
        ...
        {/* Imagen solo visible desde md+ */}
        <section className="hidden md:block w-full">
          <img src={img} alt="Finanzi ahorro" className="w-full h-screen object-contain" />
        </section>
      </div>
  </>
