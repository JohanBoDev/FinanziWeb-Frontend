...
import img from "@/assets/img/deudas-prueba.webp";
    ...
    <Header />
      ...
      <div className="relative z-10 w-full grid grid-cols-1 md:grid-cols-2 ">
        <section className="w-full flex flex-col justify-center items-center px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 text-white py-10">
          <div className="w-full max-w-3xl">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">
              Calculadora de <span className="text-[#FB2C36] drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">Deudas</span>
            </h2>
        ...
        <section className="hidden md:block w-full">
          <img src={img} alt="Finanzi Deuda" className="w-full h-screen object-contain" />
        </section>
      </div>
  </>
